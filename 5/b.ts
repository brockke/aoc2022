...
for (let m = 0; m < inputArray.length; m++){
    const testArray = stackArray[inputArray[m][1] - 1]
    .splice(stackArray[inputArray[m][1] - 1].length - inputArray[m][0], inputArray[m][0])
    stackArray[inputArray[m][2] - 1]

    stackArray[inputArray[m][2] - 1] = stackArray[inputArray[m][2] - 1].concat(testArray);
}
